#!/usr/bin/env node
// g2-runner.mjs — DEPRECATED.
// Đã hợp nhất vào autonomous-run.mjs (claim → worktree → coder → verify → PR → label).
...
console.error('[deprecated] g2-runner.mjs đã được thay bằng autonomous-run.mjs — đang chuyển tiếp.');
